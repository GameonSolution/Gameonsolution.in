...
const HomeNewsFeed: React.FC = () => {
  ...
  return (
    <section
      id="news-feed"
      className="flex flex-col gap-10 items-center select-none bg-primary px-6 md:px-20 lg:px-[7.5rem] pb-16 lg:pb-28"
    >
      <div className="w-full lg:w-[80%] flex flex-col gap-10">
        ...
        <div className="flex flex-col gap-5 text-center">
          <p className="text-base lg:text-3xl text-white font-secondary leading-relaxed">
            We specialize in bringing sports systems to the market that
