...
//                 Dhineshwaran, has many sports turfs across South India,
//                 transforming local communities and inspiring young athletes.
//                 This expansion has provided countless opportunities for young
//                 people to pursue careers in sports, turning their passion into a
//                 profession. Game On Solution has been instrumental in fulfilling
//                 these dreams, empowering the youth to see sports as a viable and
//                 rewarding path. Through quality facilities and steadfast
//                 dedication, Game On Solution is paving the way for a new
//                 generation of athletes in South India, where sports can thrive
//                 both as a passion and as a professional journey.
//               </p>
//             </AnimatedCard>
//           </div>
//         </div>
...
//                     alt="Dhineshwaran - Director at GameOn Solution"
//                   />
//                   {/* Inner Light Effect */}
      ...
      <section className="flex flex-col gap-24 justify-center items-center select-none min-h-screen bg-primary px-10 md:px-20 lg:px-[7.5rem] pb-16 lg:pb-28">
        <div className="flex flex-col w-full text-center gap-10">
          <motion.p
            ...
            className="text-[12px] font-secondary uppercase tracking-[1px]"
          >
            About Us
          </motion.p>

          <div className="flex flex-col gap-5 md:gap-6 text-base md:text-lg lg:text-2xl xl:text-3xl text-white font-secondary items-center">
            <motion.h1
              variants={fadeInUp}
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true, amount: 0.4 }}
              transition={{ duration: 0.6, ease: "easeOut" }}
              className="text-3xl md:text-4xl flex gap-2 lg:text-5xl xl:text-6xl font-primary text-white uppercase leading-tight"
            >
              <TextHoverAnimation text="who" />
              <span className="text-secondary">
                <TextHoverAnimation text="we" />
