...
const CircleMiniCricketStadiumTurf = () => {
  ...
  return (
    <section
      id="CircleMiniCricketStadiumTurf"
      className="flex flex-col gap-10 justify-center items-center select-none min-h-screen bg-primary px-10 md:px-20 lg:px-[7.5rem] pb-16 lg:pb-28"
      aria-labelledby="circle-stadium-heading"
    >
      <AnimatedCard>
        <header className="text-center px-4">
          <h1
            id="circle-stadium-heading"
            className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl flex gap-2 pb-2 font-primary text-white uppercase leading-tight"
          >
            <TextHoverAnimation text="Mini" />
            <span className="text-secondary">
              <TextHoverAnimation text="Cricket" />
      ...
      <AnimatedCard>
        <div className="w-full max-w-[1200px] px-0 lg:px-8">
          <figure
            ...
            role="img"
            aria-label="Mini Cricket Stadium Turf with high-quality playing surface"
          >
            <figcaption className="relative z-50 px-2">
              <h2 className="font-bold text-lg sm:text-xl md:text-3xl text-gray-50">
                Mini Cricket Stadium
              </h2>
            </figcaption>
          </figure>
      ...
      <AnimatedCard>
        <div className="flex flex-col items-center gap-8">
          <article className="md:text-xl lg:text-2xl text-lg text-white text-center max-w-4xl">
            <p>
              Welcome to the <strong>Circle Mini Cricket Stadium Turf</strong>,
              where passion for cricket meets high-quality, exclusive playing
              surfaces. Designed with the perfect blend of aesthetics and
              functionality, our turf offers an unmatched experience for players
              of all skill levels.
            </p>
            <p className="mt-4">
              ...
              first-rate cricketing experience in a compact setting.
            </p>
          </article>
