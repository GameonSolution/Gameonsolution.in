  ...
  return (
    <>
      ...
      <section className="flex flex-col gap-10 justify-center items-center select-none min-h-screen bg-primary px-10 md:px-20 lg:px-[7.5rem] pb-16 lg:pb-28">
        ...
        <div className="w-full flex flex-col gap-8 lg:gap-10">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-primary font-bold text-white uppercase leading-tight text-left">
            Installation<span className="text-secondary">,</span> Maintenance
            <span className="text-secondary">,</span> Renovation
          </h1>
          <p className="text-white font-secondary max-w-3xl text-left text-base md:text-lg">
            Explore our expert turf installation, maintenance, and renovation
            services tailored for football turfs, cricket grounds, and
            multi-sport synthetic surfaces. From quality turf laying to
            professional upkeep, we ensure top-notch infrastructure for your
            sports facility.
          </p>
        </div>
        ...
        <div className="w-full select-none">
          {servicesObj.map((service, index) => (
            ...
            >
              <div className="w-full md:w-[70%] flex flex-col gap-4 lg:gap-6">
                <h2 className="text-lg font-bold font-primary tracking-[1.5px] uppercase text-secondary">
                  {service.title}
                </h2>
                <div className="border-l-4 border-secondary pl-4 pr-2">
                  <p className="text-sm md:text-base font-secondary leading-relaxed text-white">
                    {service.description}
                  </p>
                </div>
              </div>
